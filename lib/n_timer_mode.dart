...
class _NTimerPageState extends State<NTimerPage> {
  ...
  Future<bool> _showAlertSettings() async {
    bool resultBool = await showDialog(
      ...
      builder: (_) {
        return AlertDialog(
          ...
          title: Row(
            ...
            children: [
              Icon(Icons.warning_amber_outlined,
                  size: 30.0, color: Color(int.parse(userConfig['secondary']))),
              const SizedBox(
                width: 10.0,
              ),
              Text('Warning',
          ...
          content: Text(
              'Going to the Settings mid game will reset the game to its original position',
              textDirection: TextDirection.ltr,
              style: TextStyle(
                  color: Color(
          ...
          actions: <Widget>[
            NeumorphicButton(
              child: Text(
                'Cancel, Stay in this Page',
                textDirection: TextDirection.ltr,
                style:
                    TextStyle(color: Color(int.parse(userConfig['secondary']))),
              ),
              onPressed: () {
                Navigator.of(
                  _,
